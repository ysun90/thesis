...
for ii=1:3
    hold on
    plot(rc,EBB(:,ii),ls{ii},'LineWidth',2,'MarkerSize',16)
    hold off   
end
set(gca,'Box','on','LineWidth',2,'FontSize',20,'XLim',[-0.9 0.5],'YLim',[0 1.3])
xlabel('\rho');
ylabel('E_{BB}')
...
hold on
plot([-rq1_md(1) -rq1_md(1)],[0 0.2],'k-.','LineWidth',2)
plot([rq1_md(1) rq1_md(1)],[0.4 0.6],'k-.','LineWidth',2)
plot([-rq1_md(2) -rq1_md(2)],[0.8 1],'r-.','LineWidth',2)
plot([rq1_md(2) rq1_md(2)],[0.8 1],'r-.','LineWidth',2)
plot([-rq1_md(3) -rq1_md(3)],[0.2 0.4],'g-.','LineWidth',2)
plot([rq1_md(3) rq1_md(3)],[0.7 0.9],'g-.','LineWidth',2)
